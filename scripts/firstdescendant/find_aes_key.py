...
The First Descendant (like Vindictus, another Nexon UE5 title) builds the key at run time with eight ``mov dword [..], imm32`` instructions, so
...
DEFAULT_EXE = r"E:\SteamLibrary\steamapps\common\The First Descendant\M1\Binaries\Win64\M1-Win64-Shipping.exe"
DEFAULT_PAK = r"E:\SteamLibrary\steamapps\common\The First Descendant\M1\Content\Paks\M1-Windows.pak"
